...
contract('rbrelay', function(accounts) {
  ...
  it("should set everything up correctly", function(done) {
    ep.getReceiptProof('0x0901fd2fa414594b57b512983764ba66cb33d534d0048f60d796f1ef5c3e04f6').then(function(result) {
      console.log(result);
  ...
  it("should relay tx 0x0901fd2fa414594b57b512983764ba66cb33d534d0048f60d796f1ef5c3e04f6", function(done) {
    rb.relayReceipt(proof.value, proof.path, proof.parentNodes, encoded, t.address).then(function(result) {
      console.log("\nrelayReceipt:\n" + JSON.stringify(result) + "\n");
    }).then(function() {
      return t.receiptDone.call();
    }).then(function(result) {
